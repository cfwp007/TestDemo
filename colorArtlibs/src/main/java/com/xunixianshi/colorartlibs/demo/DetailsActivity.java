...
package com.xunixianshi.colorartlibs.demo;
...
import com.xunixianshi.colorartlibs.FadingImageView;
import com.xunixianshi.colorartlibs.R;
...
public class DetailsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("WPTAG", "getPrimaryColor:" + colorArt.getPrimaryColor());

        Log.d("WPTAG", "getSecondaryColor:" + colorArt.getSecondaryColor());

        Log.d("WPTAG", "getDetailColor:" + colorArt.getDetailColor());
